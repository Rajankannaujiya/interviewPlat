            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-4 mb-4">
                  {interview.candidate.profileUrl ? <ProfileAvatar className="w-10 h-10" isnavbar={false} imgUrl={interview.candidate.profileUrl} /> : <NormalAvatar className="w-10 h-10" isnavbar={false}/> }
                  <div>
                ...
                <div className="flex items-center gap-4">
                  {interview.interviewr.profileUrl ? <ProfileAvatar className="w-10 h-10" isnavbar={false} imgUrl={interview.interviewr.profileUrl} /> : <NormalAvatar className="w-10 h-10" isnavbar={false} /> }
                  <div>
